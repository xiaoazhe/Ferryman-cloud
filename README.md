...
项目大概有五个月了把，最近两个月没有大的改动更新，以前的基础功能写好了，就不知道写点啥了。昂，对，就是懒，也是因为正式工作了。

以前的打算呢。。。是搞个博客，把一堆有意思的，好玩的功能啊嫖上去

但是！！ 走歪了！！走偏了！博客基础功能搞完了呢，就开始乱搞，抄这个功能，抄那个功能。得嘞，走偏了，更像个社区论坛了

以前也想过要不弄个精选的开源项目啥的，毕竟和Gitee也有过一些经历，也祝它越来越好，现在也不想着这个系统能怎么怎么样了，现在的开源好系统有很多，不倦了就。就在无聊的时候继续搞一些有趣的东西把。。。
想想哈。。。以后的规划估计就是，聊天室，爬虫，小程序，文件管理，然后集成各种三方玩。现在的功能已经不想再改了，昂，，基本能用，有产品思维的人会让我一个表单再改个七八版。也没那么多精力改了，现在看到以前觉得不错的代码都变成了烂代码。

下面就别找演示链接了，服务器太小，跑不起来，连个ELK都没有地方搭建，一个博客类的项目搞成这样的服务规模也是够了，别人一个单体项目也能实现啊。没办法，初衷就是想把自己的技术栈啊啥的放这里，毕竟，博客嘛，逻辑限制性很低，怎么搞都合理，但是前后端来回搞挺烦的，没办法，前端不用就荒废了，维护一下技术不那么手生把。
