...
import com.ferry.core.file.emums.*;
import com.ferry.core.file.object.AbstractBO;
import com.ferry.core.file.util.PasswordUtil;
...
public class User extends AbstractBO {
    ...
    public String getIsFace() {
        return sysUser.getIsFace();
    }

    public void setIsFace(String isFace) {
        this.sysUser.getIsFace();
    }

    public MultipartFile[] getFiles() {
        return sysUser.getFiles();
    }

    public void setFiles(MultipartFile[] files) {
        this.sysUser.getFiles();
    }
}
